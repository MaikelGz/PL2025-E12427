...
def p_condition(p):
    ...
    # Corregimos orden a: operador, lado_izq, lado_der
    p[0] = (p[2], p[1], p[3])
...
# Pedimos solo el número X para abrir archivo programa_pascalX.pas
numero_programa = input("Introduce el número del programa Pascal a compilar (por ejemplo, 1, 2, 3): ")
